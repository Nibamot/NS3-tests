...
struct HtRateInfo
{
  ...
  uint32_t lasttoprevNumRateAttempt;  //!< Number of transmission attempts with previous rate.
  uint32_t lasttoprevNumRateSuccess;  //!< Number of successful frames transmitted with previous rate.
