...
public:
  ...
  //Get a map of station to it's fixed snr only in case of fixed mcs
  static std::map<Mac48Address, double> fixedsnrperstation(void);

  static std::map <Mac48Address, uint32_t> getpacketsizeperstation(void);
